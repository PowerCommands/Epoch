...
export const ALL_TECHNOLOGIES: TechnologyDefinition[] = [
  ...
  },
  {
    ...
    era: 'ancient',
    cost: 35,
    description: 'Records laws, discoveries, and accounts for future scholars. Unlocks Libraries, and enables the diplomatic actions Establish Embassy and Exchange Maps (share world maps with nations you have met).',
    prerequisites: ['pottery'],
  ...
  },
  {
    ...
    era: 'classical',
    cost: 200,
    description: 'Spreads reading, writing, and the recording of knowledge beyond a scribal elite, turning the written word into a tool of learned communication. Opens paths toward scholarship and organized administration.',
  ...
  },
  {
    ...
    era: 'medieval',
    cost: 320,
    description: 'Systematizes philosophy, disciplined study, and the organization of knowledge in medieval schools. Unlocks Gardens, raises Angkor Wat and Hagia Sophia, and leads toward formal education.',
  ...
  },
  {
    ...
    era: 'medieval',
    cost: 440,
    description: 'Develops practical methods for managing increasingly complex states and territories. Unlocks Pikemen and supports more coordinated government.',
  ...
  },
  {
    ...
    era: 'medieval',
    cost: 375,
    description: 'Advances skilled production, specialized tools, and the refined techniques of craftsmanship. Opens paths toward machinery, chivalry, and specialized city growth.',
  ...
  },
  {
    ...
    era: 'modern',
    cost: 7000,
    description: 'Links the world through communication grids, transport links, and integrated technical infrastructure. Leads toward particle physics and future-era research.',
