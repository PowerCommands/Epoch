...
export const CULTURE_TREE: CultureNode[] = [
  ...
  node({ id: 'games_recreation', name: 'Games Of Nations', era: 'classical', cost: 200, description: 'Nations turn competition into grand public games. The first nation to complete this founds the Games of Nations, and the confirmed host city can raise a Grand Stadium to hold the contests.', prerequisites: ['state_workforce'], unlocks: [{ type: 'policySlot', value: 'culture' }] }),
  ...
  node({ id: 'civil_service_civics', name: 'Civil Service', era: 'medieval', cost: 200, description: 'Administration becomes a profession instead of a favor. Trained officials help distant cities answer to the same state.', prerequisites: ['recorded_history'], unlocks: [] }),
  node({ id: 'mercenaries', name: 'Mercenaries', era: 'medieval', cost: 210, description: 'War becomes a market as soldiers sell skill to the highest cause. Coin, contracts, and reputation can raise armies quickly.', prerequisites: ['feudalism'], unlocks: [] }),
  ...
  node({ id: 'civil_engineering', name: 'Civil Engineering', era: 'industrial', cost: 525, description: 'Public works become symbols of modern administration. Bridges, districts, and services let cities grow with intent.', prerequisites: ['enlightenment'], unlocks: [] }),
  ...
  node({ id: 'mobilization', name: 'Mobilization', era: 'atomic', cost: 780, description: 'Industry, citizens, and command networks prepare for total war. The nation learns to move as one vast military machine.', prerequisites: ['ideology'], unlocks: [] }),
