...
export const CULTURE_TREE: CultureNode[] = [
  ...
  node({ id: 'nationalism', name: 'Nationalism', era: 'renaissance', cost: 440, description: 'Shared language, memory, and symbols forge mass identity. Popular movements, independence struggles, and organized resistance take root.', prerequisites: ['humanism', 'mercantilism'], unlocks: [{ type: 'unit', value: 'rebels' }] }),
