...
export const ARTILLERY = unit({ id: 'artillery', name: 'Artillery', era: 'industrial', cost: 250, combatStrength: 27, rangedStrength: 28, range: 4, movement: 2, category: 'siege', upkeepGold: 9, upgradeToUnitId: 'rocket_artillery' }); // raised: industrial siege matches rifleman tier, 6→9
