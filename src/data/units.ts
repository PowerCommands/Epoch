...
export const GALLEASS = unit({ id: 'galleass', name: 'Galleass', era: 'medieval', cost: 100, combatStrength: 16, rangedStrength: 17, range: 5, movement: 3, category: 'naval_ranged', isNaval: true, upkeepGold: 3, upgradeToUnitId: 'frigate' });
...
export const FRIGATE = unit({ id: 'frigate', name: 'Frigate', era: 'renaissance', cost: 185, combatStrength: 25, rangedStrength: 28, range: 7, movement: 5, category: 'naval_ranged', isNaval: true, upkeepGold: 3, upgradeToUnitId: 'battleship' });
...
export const MISSILE_CRUISER = unit({ id: 'missile_cruiser', name: 'Missile Cruiser', era: 'information', cost: 425, combatStrength: 83, rangedStrength: 100, range: 13, movement: 7, category: 'naval_ranged', isNaval: true, upkeepGold: 9 });
