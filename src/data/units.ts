...
export const WARRIOR = unit({ id: 'warrior', name: 'Warrior', era: 'ancient', cost: 40, combatStrength: 8, movement: 2, category: 'melee', upkeepGold: 3, upgradeToUnitId: 'swordsman' });
...
export const ARCHER = unit({ id: 'archer', name: 'Archer', era: 'ancient', cost: 40, combatStrength: 5, rangedStrength: 7, range: 2, movement: 2, category: 'ranged', upkeepGold: 3, upgradeToUnitId: 'composite_bowman' });
...
export const SWORDSMAN = unit({ id: 'swordsman', name: 'Swordsman', era: 'classical', cost: 75, combatStrength: 14, movement: 2, category: 'melee', requiredResource: { resourceId: 'iron', amount: 1 }, upkeepGold: 3, upgradeToUnitId: 'longswordsman' });

export const PIKEMAN = unit({ id: 'pikeman', name: 'Pikeman', era: 'medieval', cost: 90, combatStrength: 17, movement: 2, category: 'melee', upkeepGold: 6, upgradeToUnitId: 'lancer' });
export const CROSSBOWMAN = unit({ id: 'crossbowman', name: 'Crossbowman', era: 'medieval', cost: 120, combatStrength: 13, rangedStrength: 18, range: 2, movement: 2, category: 'ranged', upkeepGold: 6, upgradeToUnitId: 'gatling_gun' });
...
export const TREBUCHET = unit({ id: 'trebuchet', name: 'Trebuchet', era: 'medieval', cost: 120, combatStrength: 12, rangedStrength: 14, range: 2, movement: 2, category: 'siege' , upkeepGold: 3, upgradeToUnitId: 'cannon' });
export const GALLEASS = unit({ id: 'galleass', name: 'Galleass', era: 'medieval', cost: 100, combatStrength: 16, rangedStrength: 17, range: 2, movement: 3, category: 'naval_ranged', isNaval: true, upkeepGold: 3, upgradeToUnitId: 'frigate' });
...
export const CARAVEL = unit({ id: 'caravel', name: 'Caravel', era: 'renaissance', cost: 120, combatStrength: 20, movement: 4, category: 'naval_melee', isNaval: true, upkeepGold: 3, upgradeToUnitId: 'privateer' });
export const FRIGATE = unit({ id: 'frigate', name: 'Frigate', era: 'renaissance', cost: 185, combatStrength: 25, rangedStrength: 28, range: 2, movement: 5, category: 'naval_ranged', isNaval: true, upkeepGold: 3, upgradeToUnitId: 'battleship' });
export const PRIVATEER = unit({ id: 'privateer', name: 'Privateer', era: 'renaissance', cost: 150, combatStrength: 30, movement: 5, category: 'naval_melee', isNaval: true, upkeepGold: 3, upgradeToUnitId: 'ironclad' });
...
export const ARTILLERY = unit({ id: 'artillery', name: 'Artillery', era: 'industrial', cost: 250, combatStrength: 27, rangedStrength: 28, range: 3, movement: 2, category: 'siege', upkeepGold: 3, upgradeToUnitId: 'rocket_artillery' });
export const IRONCLAD = unit({ id: 'ironclad', name: 'Ironclad', era: 'industrial', cost: 250, combatStrength: 50, movement: 3, category: 'naval_melee', isNaval: true, upkeepGold: 3, upgradeToUnitId: 'destroyer' });
export const GATLING_GUN = unit({ id: 'gatling_gun', name: 'Gatling Gun', era: 'industrial', cost: 225, combatStrength: 36, rangedStrength: 36, range: 1, movement: 2, category: 'ranged', upkeepGold: 3, upgradeToUnitId: 'machine_gun' });
...
export const GREAT_WAR_INFANTRY = unit({ id: 'great_war_infantry', name: 'Great War Infantry', era: 'modern', cost: 320, combatStrength: 72, movement: 2, category: 'melee' , upkeepGold: 3, upgradeToUnitId: 'infantry' });
...
export const MACHINE_GUN = unit({ id: 'machine_gun', name: 'Machine Gun', era: 'modern', cost: 350, combatStrength: 60, rangedStrength: 60, range: 1, movement: 2, category: 'ranged', upkeepGold: 3, upgradeToUnitId: 'bazooka' });
...
export const ANTI_TANK_GUN = unit({ id: 'anti_tank_gun', name: 'Anti-Tank Gun', era: 'atomic', cost: 300, combatStrength: 50, movement: 2, category: 'ranged', upkeepGold: 3, upgradeToUnitId: 'bazooka' });
...
export const NUCLEAR_SUBMARINE = unit({ id: 'nuclear_submarine', name: 'Nuclear Submarine', era: 'atomic', cost: 425, combatStrength: 53, rangedStrength: 85, range: 3, movement: 6, category: 'naval_ranged', isNaval: true, requiredResource: { resourceId: 'uranium', amount: 1 }, upkeepGold: 15 });
...
export const BAZOOKA = unit({ id: 'bazooka', name: 'Bazooka', era: 'atomic', cost: 375, combatStrength: 90, rangedStrength: 85, range: 1, movement: 2, category: 'ranged', upkeepGold: 3 });
...
export const MISSILE_CRUISER = unit({ id: 'missile_cruiser', name: 'Missile Cruiser', era: 'information', cost: 425, combatStrength: 83, rangedStrength: 100, range: 3, movement: 7, category: 'naval_ranged', isNaval: true, upkeepGold: 9 });
