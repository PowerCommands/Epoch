...
export const ARCHAEOLOGIST = unit({ id: 'archaeologist', name: 'Archaeologist', era: 'renaissance', cost: 200, combatStrength: 0, movement: 4, category: 'civilian', improvementCapabilities: ['dig'] });
