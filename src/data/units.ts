...
export const FRIGATE = unit({ id: 'frigate', name: 'Frigate', era: 'renaissance', cost: 175, combatStrength: 25, rangedStrength: 20, range: 7, movement: 4, category: 'naval_ranged', isNaval: true, upkeepGold: 6, upgradeToUnitId: 'battleship' }); // raised: capital ship of the age, 3→6
...
export const IRONCLAD = unit({ id: 'ironclad', name: 'Ironclad', era: 'industrial', cost: 280, combatStrength: 50, rangedStrength: 28, range: 8, movement: 5, category: 'naval_melee', isNaval: true, upkeepGold: 9, upgradeToUnitId: 'destroyer' }); // raised: steam warship matches industrial tier, 6→9
