...
export const FRIGATE = unit({ id: 'frigate', name: 'Frigate', era: 'renaissance', cost: 175, combatStrength: 25, range: 7, rangedStrength: 18, movement: 4, category: 'naval_ranged', isNaval: true, upkeepGold: 5, upgradeToUnitId: 'battleship' }); // raised: capital ship of the age, 3→6
