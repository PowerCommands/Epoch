...
export const ARCHER_GALLEY = unit({ id: 'archer_galley', name: 'Archer Galley', era: 'classical', cost: 50, combatStrength: 10, rangedStrength: 12, range: 4, movement: 3, category: 'naval_ranged', isNaval: true, upkeepGold: 2, upgradeToUnitId: 'galleass', serviceLifeRounds: 120 });
...
export const TREBUCHET = unit({ id: 'trebuchet', name: 'Trebuchet', era: 'medieval', cost: 120, combatStrength: 12, rangedStrength: 14, range: 5, movement: 2, category: 'siege' , upkeepGold: 3, upgradeToUnitId: 'cannon', serviceLifeRounds: 120 });
export const GALLEASS = unit({ id: 'galleass', name: 'Galleass', era: 'medieval', cost: 100, combatStrength: 16, rangedStrength: 18, range: 6, movement: 4, category: 'naval_ranged', isNaval: true, upkeepGold: 3, upgradeToUnitId: 'frigate', serviceLifeRounds: 120 });
