...
export const HORSEMAN = unit({ id: 'horseman', name: 'Horseman', era: 'classical', cost: 75, combatStrength: 12, movement: 4, category: 'mounted' });
...
export const SWORDSMAN = unit({ id: 'swordsman', name: 'Swordsman', era: 'classical', cost: 75, combatStrength: 14, movement: 2, category: 'melee' });
...
export const LONGSWORDSMAN = unit({ id: 'longswordsman', name: 'Longswordsman', era: 'medieval', cost: 120, combatStrength: 21, movement: 2, category: 'melee' });
export const KNIGHT = unit({ id: 'knight', name: 'Knight', era: 'medieval', cost: 120, combatStrength: 20, movement: 4, category: 'mounted' });
...
export const RIFLEMAN = unit({ id: 'rifleman', name: 'Rifleman', era: 'industrial', cost: 225, combatStrength: 34, movement: 2, category: 'melee' });
export const CAVALRY = unit({ id: 'cavalry', name: 'Cavalry', era: 'industrial', cost: 225, combatStrength: 34, movement: 4, category: 'mounted' });
...
export const LANDSHIP = unit({ id: 'landship', name: 'Landship', era: 'modern', cost: 350, combatStrength: 60, movement: 4, category: 'mounted' });
...
export const BATTLESHIP = unit({ id: 'battleship', name: 'Battleship', era: 'modern', cost: 375, combatStrength: 55, rangedStrength: 65, range: 3, movement: 5, category: 'naval_ranged', isNaval: true });
export const CARRIER = unit({ id: 'carrier', name: 'Carrier', era: 'modern', cost: 375, combatStrength: 50, movement: 5, category: 'naval_ranged', isNaval: true });
...
export const TANK = unit({ id: 'tank', name: 'Tank', era: 'atomic', cost: 375, combatStrength: 70, movement: 5, category: 'mounted' });
...
export const NUCLEAR_SUBMARINE = unit({ id: 'nuclear_submarine', name: 'Nuclear Submarine', era: 'atomic', cost: 425, combatStrength: 50, rangedStrength: 85, range: 3, movement: 6, category: 'naval_ranged', isNaval: true });
export const ATOMIC_BOMB = unit({ id: 'atomic_bomb', name: 'Atomic Bomb', era: 'atomic', cost: 600, combatStrength: 0, range: 10, movement: 2, category: 'air' });
...
export const NUCLEAR_MISSILE = unit({ id: 'nuclear_missile', name: 'Nuclear Missile', era: 'information', cost: 1000, combatStrength: 0, range: 12, movement: 2, category: 'air' });
