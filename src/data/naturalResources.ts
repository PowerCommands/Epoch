...
export const NATURAL_RESOURCES: NaturalResourceDefinition[] = [
  ...
  },
  {
    ...
    name: 'Iron',
    category: 'strategic',
    allowedTileTypes: [TileType.Mountain, TileType.Plains, TileType.Beach, TileType.Meadow],
    yieldBonus: yieldBonus({ production: 1 }),
  ...
  },
  {
    ...
    name: 'Niter',
    category: 'strategic',
    allowedTileTypes: [TileType.Plains, TileType.Beach, TileType.Meadow, TileType.Desert],
    yieldBonus: yieldBonus({ production: 1 }),
  ...
  },
  {
    ...
    name: 'Oil',
    category: 'strategic',
    allowedTileTypes: [TileType.Desert, TileType.Ocean, TileType.Ice, TileType.Plains, TileType.Beach, TileType.Meadow],
