...
/**
 * CityWorkTileRenderer — outlines workable and worked tiles when a city is selected.
 * Worked tiles get a stronger outline, non-worked workable tiles a weaker one.
 */
